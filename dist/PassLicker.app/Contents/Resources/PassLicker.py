...
root.iconbitmap("passlicker.png")
...
def pushit_click():
    ...
    link = pw.push_passphrase(passphrase, int(expire_days_box.get()), int(expire_views_box.get()))
...
passphrase_settings_label.grid(column=0, row=0,columnspan=2)
num_chars_box.grid(column=1, row=1)
total_words_box.grid(column=1, row=2)
word_separator_box.grid(column=1, row=3)
include_digits_box.grid(column=1, row=4)
expire_days_box.grid(column=4, row=2)
expire_views_box.grid(column=4, row=3)


num_chars_label.grid(column=0, row=1)
total_words_label.grid(column=0, row=2)
word_separator_label.grid(column=0, row=3)
include_digits_label.grid(column=0, row=4)

link_settings_label.grid(column=3, row=0, columnspan=2)
expire_days_label.grid(column=3, row=2)
expire_views_label.grid(column=3, row=3)


text_box.grid(column=0, row=6, columnspan=5)
