...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.push_specific_button = QtWidgets.QPushButton(self.specific_buttons)
        ...
        self.expire_views_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.expire_days_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy.setHeightForWidth(self.expire_days_box.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.expire_views_box.sizePolicy().hasHeightForWidth())
        ...
        self.num_chars_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.num_chars_box.sizePolicy().hasHeightForWidth())
        ...
        self.include_digits_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.total_words_box.sizePolicy().hasHeightForWidth())
        ...
        self.include_digits_box.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.word_separator.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.total_word_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gen_push_button.setText(_translate("MainWindow", "Generate and Push Passphrase"))
        self.gen_button.setText(_translate("MainWindow", "Generate Passphrase"))
        self.specific_buttons.setTitle(_translate("MainWindow", "Specific Passphrase"))
        self.push_specific_button.setText(_translate("MainWindow", "Push Specific Passphrase"))
        self.link_opts.setTitle(_translate("MainWindow", "Link Settings"))
        self.expire_views_label.setText(_translate("MainWindow", "Views to Expire"))
        self.expire_days_label.setText(_translate("MainWindow", "Days to Expire"))
        self.pass_opts.setTitle(_translate("MainWindow", "Passphrase Settings:"))
        self.num_chars_label.setText(_translate("MainWindow", "Number of Characters"))
        self.include_digits_label.setText(_translate("MainWindow", "Include Digits"))
